...
namespace {
struct qt_meta_tag_ZN7SurfaceE_t {};
} // unnamed namespace

template <> constexpr inline auto Surface::qt_create_metaobjectdata<qt_meta_tag_ZN7SurfaceE_t>()
{
...
Q_CONSTINIT const QMetaObject Surface::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SurfaceE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SurfaceE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7SurfaceE_t>.metaTypes,
    nullptr
} };
...
void *Surface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SurfaceE_t>.strings))
